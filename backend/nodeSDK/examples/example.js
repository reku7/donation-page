...
const notifyUrl = "https://webhook.site/816701ef-3f5d-4314-8e96-4b3f083341e6";
...
client
  ...
  .then((url) => {
    // client.generatePaymentUrl(id, 1, "payment", successRedirectUrl, failureRedirectUrl, notifyUrl, "+251927913363", cancelRedirectUrl).then(url => {
